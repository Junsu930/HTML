...
function fnConfirm(){
    ...
    const qes = window.confirm("배경색을 분홍색으로 바꾸시겠습니까?");
    
    if(qes){
        document.getElementById("confirmTest").style.background="pink";
    }
}
...
function ww(){
    document.getElementById("sea").style.visibility="visible";
    document.getElementById("sea").style.width="150px";
}


function ss(){
    document.getElementById("sea").style.visibility="hidden";
    document.getElementById("sea").style.width="0px";
}