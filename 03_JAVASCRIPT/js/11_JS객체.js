...
document.getElementById("btn2").addEventListener("click", function(){
    ...
    stdList.push(new Student(1, 2, '헝차웅'));
    stdList.push(new Student(2, 1, '띠로뽕'));
    stdList.push(new Student(3, 4, '숭가이'));
    stdList.push(new Student(1, 8, '발발이'));
...
function Student(grade, classroom, name){
    // 생성자 함수에서의 this
    ...
    this.introduce = function(){
        return this.grade + "학년 " + this.classroom + "반 " + this.name;
    }
